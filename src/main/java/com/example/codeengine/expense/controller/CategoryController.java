...
public class CategoryController {
	...
	ResponseEntity<Category> createCategory(@Validated @RequestBody Category categories) throws URISyntaxException{
	  Category result= categoryRepository.save(categories);
//	  return ResponseEntity.created(new URI("/api/category" + result.getId()+ result.getName())).body(result); 
	...
	ResponseEntity<?> deleteAll(Category category){
